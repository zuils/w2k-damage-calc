    ...
    test('moves', function () {
        ...
        try {
            for (var gens_3 = __values(gens), gens_3_1 = gens_3.next(); !gens_3_1.done; gens_3_1 = gens_3.next()) {
                ...
                var c = new Map();
                try {
                    for (var _d = (e_8 = void 0, __values(calc.Generations.get(gen).moves)), _e = _d.next(); !_e.done; _e = _d.next()) {
                        var move = _e.value;
                        c.set(move.id, move);
                    }
                }
    ...
    test('species', function () {
        ...
        try {
            for (var gens_4 = __values(gens), gens_4_1 = gens_4.next(); !gens_4_1.done; gens_4_1 = gens_4.next()) {
                ...
                var c = new Map();
                try {
                    for (var _d = (e_11 = void 0, __values(calc.Generations.get(gen).species)), _e = _d.next(); !_e.done; _e = _d.next()) {
                        var specie = _e.value;
    ...
    test('types', function () {
        ...
        try {
            for (var gens_5 = __values(gens), gens_5_1 = gens_5.next(); !gens_5_1.done; gens_5_1 = gens_5.next()) {
                ...
                var c = new Map();
                try {
                    for (var _d = (e_14 = void 0, __values(calc.Generations.get(gen).types)), _e = _d.next(); !_e.done; _e = _d.next()) {
                        var type = _e.value;
                        c.set(type.id, type);
                    }
                }
    ...
    test('natures', function () {
        ...
        try {
            for (var gens_6 = __values(gens), gens_6_1 = gens_6.next(); !gens_6_1.done; gens_6_1 = gens_6.next()) {
                ...
                var c = new Map();
                try {
                    for (var _d = (e_17 = void 0, __values(calc.Generations.get(gen).natures)), _e = _d.next(); !_e.done; _e = _d.next()) {
                        var nature = _e.value;
