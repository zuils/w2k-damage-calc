...
var BW_PATCH = {
    Rayquaza: { bs: { hp: 105, at: 180, df: 100, sa: 180, sd: 100, sp: 115 } },
    ...
    Luxio: { types: ['Electric', 'Dark'] },
    Luxray: { types: ['Electric', 'Dark'] },
    Vibrava: { types: ['Bug', 'Dragon'] },
    Flygon: { types: ['Bug', 'Dragon'] },
    'Deoxys-Attack': { types: ['Psychic', 'Fighting'] },
    Accelgor: {
        types: ['Bug'],
